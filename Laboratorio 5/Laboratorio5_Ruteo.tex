...
en todas las interfaces. Utilice el número de área \texttt{1} si se encuentra en la red \texttt{192.168.100.0/22} y \texttt{2} si está en \texttt{192.168.200.0/22}.
